...
import { CoordenadorEstagioProps } from "@/pages/InstituicaoEnsino/CoordenadorEstagio/TableCoordenadorEstagio/table/columns";
  ...
  async function onSubmit(values: FormCadastroProps) {
    ...
    !isEdit ?
      await api
        ...
        .finally(() => navigate("/instituicao/documento"))
        : await api
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <CardFooter className="flex gap-4">
            ...
            <Button
              type="button"
              variant="secondary"
              onClick={() => navigate("/instituicao/documento")}
            >
              Voltar
            </Button>
          </CardFooter>
